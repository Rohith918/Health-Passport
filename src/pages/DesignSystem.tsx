  ...
  return (
    <div style={{ padding: "32px 32px 80px", maxWidth: 1200 }} className="">
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        >
          Health Passport component library — tokens, typography, interactive
          states, and patterns for developer handoff.
        </p>
      </div>
      ...
      <Section title="Typography">
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          {[
            ...
            {
              label: "Heading / Fraunces 300 italic",
              style: {
                fontFamily: "'Fraunces', Georgia, serif",
                fontWeight: 300,
                fontSize: 28,
              ...
              text: "Your health, legibly recorded.",
            },
            {
              label: "Section / Fraunces 600",
              style: {
                fontFamily: "'Fraunces', Georgia, serif",
                fontWeight: 600,
                fontSize: 20,
            ...
            {
              label: "Body / Outfit 400",
              style: {
                fontFamily: "'Outfit', sans-serif",
                fontSize: 15,
                color: "#1A1814",
              },
              text: "Track your heart rate, glucose, and liver function in one private place.",
            },
            {
              label: "Small / Outfit 500",
              style: {
                fontFamily: "'Outfit', sans-serif",
                fontSize: 13,
                fontWeight: 500,
            ...
            {
              label: "Data / DM Mono 400",
              style: {
                fontFamily: "'DM Mono', monospace",
                fontSize: 14,
                color: "#1A1814",
              },
              text: "128 mg/dL · Fasting Glucose",
            },
            {
              label: "Label / DM Mono uppercase",
              style: {
                fontFamily: "'DM Mono', monospace",
                fontSize: 10,
                letterSpacing: "0.1em",
              ...
              text: "NORMAL RANGE · LAST 6 MONTHS",
            },
          ].map((item) => (
            <div
              key={item.label}
      ...
      <Section title="Buttons">
        ...
        >
          ...
          <button style={{ ...btnPrimary, background: "#244E3A" }}>
            Hover state
          </button>
          <button
        ...
        >
          ...
          <button style={{ ...btnDestructive, background: "#A83618" }}>
            Hover state
          </button>
        </div>
      </Section>
      ...
      <Section title="Status Indicators">
        ...
        >
          ...
          <div>
            ...
            >
              Alert banner — out-of-range values detected
            </div>
            <div
              style={{
                fontFamily: "'Outfit', sans-serif",
            ...
            >
              Review the affected metrics and consult your healthcare provider.
            </div>
          </div>
        </div>
      ...
      <Section title="Data Card & Table Row">
        ...
        >
          ...
          >
            {[
              { label: "Heart Rate", val: "88 bpm", status: "normal" },
              { label: "LDL", val: "142 mg/dL", status: "high" },
            ].map((row) => (
              <div key={row.label}>
                <div
                  style={{
                ...
                <span
                  style={{
                    ...
                    fontSize: 18,
                    fontWeight: 500,
                    color: row.status === "high" ? "#D9502E" : "#1A1814",
                  }}
                >
                  {row.val}
                </span>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                gridTemplateColumns: "140px 1fr 1fr 80px",
                padding: "12px 16px",
                borderBottom: i === 0 ? "1px solid #EDE8DC" : "none",
                alignItems: "center",
              }}
            >
              <div
              ...
              <div>
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <path
                      d="M2.5 3.5h9M5 3.5V2.5A.5.5 0 0 1 5.5 2h3a.5.5 0 0 1 .5.5v1M4.5 3.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7"
                      stroke="currentColor"
                      strokeWidth="1.2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
      ...
      <Section title="Empty State">
        ...
        >
          ...
          >
            Add your first reading to begin tracking
          </p>
          <button
            style={{
              background: "#EAF4EE",
      ...
      <Section title="Modal & Bottom Sheet">
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <button onClick={() => setModalOpen(true)} style={btnSecondary}>
            Open modal (desktop)
          </button>
          <button onClick={() => setSheetOpen(true)} style={btnSecondary}>
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            ...
            >
              This is a standard modal. On mobile (&lt;1024px) it becomes a
              full-width bottom sheet with a drag handle and slides up from the
              bottom edge.
            </p>
            <div
            ...
            >
              ...
              <button onClick={() => setModalOpen(false)} style={btnPrimary}>
                Confirm
              </button>
            </div>
          </div>
      ...
      {sheetOpen && (
        ...
        >
          ...
          >
            ...
            >
              Slides up from the bottom edge. Features a drag handle and
              full-width layout. Used for the Add Record form on mobile
              viewports.
            </p>
            <button
              onClick={() => setSheetOpen(false)}
